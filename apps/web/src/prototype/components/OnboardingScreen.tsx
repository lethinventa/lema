  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-4 pt-6">
        {eyebrow ? (
          <span className="mb-2 block text-[12px] font-semibold uppercase tracking-wide text-accent">
            {eyebrow}
          </span>
        ) : null}
        <h1 className="text-[26px] font-bold leading-tight text-ink">{title}</h1>
        {subtitle ? <p className="mt-2 text-[15px] leading-snug text-ink-muted">{subtitle}</p> : null}
