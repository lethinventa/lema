...
- Um objetivo possui progresso intermediário, representado como percentual (0% a 100%). O progresso pode ser atualizado manualmente pelo ator, ou refletir a proporção de recursos relacionados já concluídos, quando o objetivo tiver relações desse tipo (ver `UC-GOAL-007`).
